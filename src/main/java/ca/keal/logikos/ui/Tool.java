 ...
 * tool selected, hovers over a spot on the field, {@link #onHover(double, double, FieldComponent)} is called, and when
 * they click using this tool {@link #onClick(double, double, FieldComponent)} is called. Tools also have a name and a
 * tooltip.
 */
public abstract class Tool {
   ...
   */
  public abstract void onHover(double paneX, double paneY, FieldComponent hoveredFC);
   ...
   */
  public abstract void onClick(double paneX, double paneY, FieldComponent clickedFC);
